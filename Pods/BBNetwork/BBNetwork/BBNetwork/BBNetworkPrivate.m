...
@implementation BBNetworkPrivate
...
+ (void)addDoNotBackupAttribute:(NSString *)path {
    ...
    if (error) {
        BBNLog(@"error to set do not backup attribute, error = %@", error);
    }
}
...
@implementation BBBaseRequest (RequestAccessory)

- (void)toggleAccessoriesWillStartCallBack {
    for (id<BBRequestAccessory> accessory in self.requestAccessories) {
...
@implementation BBBatchRequest (RequestAccessory)
...
@implementation BBChainRequest (RequestAccessory)

...
@interface TTSCollectionViewSection ()
...
@implementation TTSCollectionViewSection
...
- (NSUInteger)index
{
    TTSCollectionViewManager *collectionViewManager = self.collectionManager;
...
- (void)setHeaderItem:(TTSCollectionReusableViewItem *)headerItem {
    if ([headerItem isKindOfClass:[TTSCollectionReusableViewItem class]]) {
        headerItem.section = self;
    }
    _headerItem = headerItem;
}

- (void)setFooterItem:(TTSCollectionReusableViewItem *)footerItem {
    if ([footerItem isKindOfClass:[TTSCollectionReusableViewItem class]]) {
...
- (void)addItem:(id)item
{
    if ([item isKindOfClass:[TTSCollectionViewItem class]])
        ((TTSCollectionViewItem *)item).section = self;
...
{
    for (TTSCollectionViewItem *item in array)
        if ([item isKindOfClass:[TTSCollectionViewItem class]])
            ((TTSCollectionViewItem *)item).section = self;
...
{
    for (TTSCollectionViewItem *item in items)
        if ([item isKindOfClass:[TTSCollectionViewItem class]])
            ((TTSCollectionViewItem *)item).section = self;
...
{
    for (TTSCollectionViewItem *item in otherArray)
        if ([item isKindOfClass:[TTSCollectionViewItem class]])
            ((TTSCollectionViewItem *)item).section = self;
